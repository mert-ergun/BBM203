...
public:
    ...
    vector<vector<bool>> rotate_left(const vector<vector<bool>> & shape); // Rotates the given shape to the left
    vector<vector<bool>> rotate_right(const vector<vector<bool>> & shape); // Rotates the given shape to the right
};
